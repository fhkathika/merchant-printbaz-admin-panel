...
const Navigationbar = () => {
    ...
    let roleOneTimeFilter = adminUser?.roles?.reduce((acc, current) => {
    ...
    const roleToCompare = ['Dashboard', 'Merchants', 'Orders', 'Ticket'];
    const compareObjectsByProperty = (property, value) => (obj) => obj[property] === value;
