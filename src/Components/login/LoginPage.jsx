...
function LoginPage() {
  ...
  const loginUser = async (e) => {
    e.preventDefault();
    try {
      // const res = await axios.post("http://localhost:5000/loginFromAdminPanel", { email });
      const res = await axios.post("https://mserver.printbaz.com/loginFromAdminPanel", { email });
  ...
  return (
    <div>
       ...
       {/* <Navigationbar/> */}
         ...
         <div className="col-md-8  mx-auto mt-5 p-3">
                <div className="card stat-card">
                  <div className="card-body">
                    <h2>Login Form</h2>
                  <Form  onSubmit={loginUser}>   
        <Form.Group className="mb-3" controlId="formBasicEmail">
          <Form.Label className="card-title">Email address</Form.Label>
          <Form.Control
            type="email"
            name="email"
            value={email}
